...
ListAccountsHandler::ListAccountsHandler(QString const& prog_name, QDBusConnection const& conn, QDBusMessage const& msg)
    : conn_(conn)
    , msg_(msg)
...
{
    { "google-drive-scope", { "com.canonical.StorageFramework.Provider.ProviderTest", "Google" } },
