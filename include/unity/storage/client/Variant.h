...
public:
    ...
    */
    ...
    /**
    \brief Returns a hash value for this Variant.
    */
    size_t hash() const;
    ...
    */
    std::string serialize_json() const;  // TODO: drop this?
    /**
    \brief Deserializes a JSON encoded string to a `Variant`.
    */
    static Variant deserialize_json(std::string const& json_string);  // TODO: drop this?
    //@}
...
template<>
struct hash<unity::storage::client::Variant>
{
    typedef unity::storage::client::Variant argument_type;
